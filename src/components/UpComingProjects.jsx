...
const UpComingProjects = () => {
  return (
    <div id='upcoming' className='pt-20 px-5 pb-[136px] text-center'>
     ...
     <div className='py-12 flex gap-7 flex-wrap justify-center text-start max-lg:py-10 max-md:py-8 max-sm:pb-4 max-md:gap-5 max-sm:gap-3'>
        ...
        <div key={i} className='w-full max-w-[263px] max-md:max-w-[220px] border border-off-white rounded-xl p-4 bg-off-white backdrop-filter backdrop-blur-[30px] shadow-project-box'>
          ...
          <div className='pt-4'>
            <div className='flex w-full justify-between items-center'>
              <h4 className='text-xl font-medium leading-custom-3xl text-white max-md:text-lg'>{obj.name}</h4>
              <p className='text-base font-bold leading-custom-3xl text-white'>15 : 54 : 12</p>
            </div>
